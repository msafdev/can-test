<template>
    <div class="border-2 overflow-hidden w-full relative rounded-xl group cursor-pointer" @click="goToGameDetail">
        ...
        <div
            class="absolute bottom-0 md:-bottom-full group-hover:bottom-0 transition-all duration-300 ease-in-out bg-card text-card-foreground w-full backdrop-blur p-3">
